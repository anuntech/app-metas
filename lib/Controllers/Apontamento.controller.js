...
const getApontamentosWithFiltersController = async (filters, showAllEntries = false) => {
  await dbConnect();
  const result = await getApontamentosWithFiltersService(filters, showAllEntries);
  return result;
};
